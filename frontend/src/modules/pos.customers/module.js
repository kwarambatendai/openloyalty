...
angular.module(MODULE_NAME, [])
        ...
        $stateProvider
            .state('seller.panel.customer-search', {
                ...
                views: {
                    ...
                    'main@': {
                        templateUrl: './templates/seller-find-customer.html',
                        controller: 'SellerCustomerController',
                        controllerAs: 'SellerCustomerCtrl'
                    },
                    'extendBottom@': {
            ...
            .state('seller.panel.customer-registration', {
                ...
                views: {
                    ...
                    'main@': {
                        templateUrl: './templates/seller-customer-registration.html',
                        controller: 'SellerCustomerController',
                        controllerAs: 'SellerCustomerCtrl'
                    },
                    'extendBottom@': {
            ...
            .state('seller.panel.edit-customer', {
                ...
                views: {
                    ...
                    'main@': {
                        templateUrl: './templates/seller-customer-edit.html',
                        controller: 'SellerCustomerController',
                        controllerAs: 'SellerCustomerCtrl'
                    },
                    'extendBottom@': {
            ...
            .state('seller.panel.single-customer', {
                ...
                views: {
                    ...
                    'main@': {
                        templateUrl: './templates/seller-single-customer.html',
                        controller: 'SellerCustomerController',
                        controllerAs: 'SellerCustomerCtrl'
                    },
                    'extendBottom@': {
            ...
            .state('seller.panel.single-customer.rewards', {
                ...
                views: {
                    ...
                    'main@': {
                        templateUrl: './templates/seller-customer-rewards.html',
                        controller: 'SellerCustomerController',
                        controllerAs: 'SellerCustomerCtrl'
                    },
                    'extendBottom@': {
            ...
            .state('seller.panel.single-customer.transactions', {
                ...
                views: {
                    ...
                    'main@': {
                        templateUrl: './templates/seller-customer-transactions.html',
                        controller: 'SellerCustomerController',
                        controllerAs: 'SellerCustomerCtrl'
                    },
                    'extendBottom@': {
            ...
            .state('seller.panel.single-customer.transfers', {
                ...
                views: {
                    ...
                    'main@': {
                        templateUrl: './templates/seller-customer-transfers.html',
                        controller: 'SellerCustomerController',
                        controllerAs: 'SellerCustomerCtrl'
                    },
                    'extendBottom@': {
            ...
            .state('seller.panel.single-customer.campaigns', {
                ...
                views: {
                    ...
                    'main@': {
                        templateUrl: './templates/seller-customer-campaigns.html',
                        controller: 'SellerCustomerController',
                        controllerAs: 'SellerCustomerCtrl'
                    },
                    'extendBottom@': {
    ...
    .run(($templateCache, $http) => {
        ...
        $http.get(`./build/${MODULE_NAME}/templates/seller-find-customer.html`)
            .then(
                response => {
        ...
        $http.get(`./build/${MODULE_NAME}/templates/seller-customer-registration.html`)
            .then(
                response => {
        ...
        $http.get(`./build/${MODULE_NAME}/templates/seller-customer-edit.html`)
            .then(
                response => {
        ...
        $http.get(`./build/${MODULE_NAME}/templates/seller-single-customer.html`)
            .then(
                response => {
        ...
        $http.get(`./build/${MODULE_NAME}/templates/seller-customer-rewards.html`)
            .then(
                response => {
        ...
        $http.get(`./build/${MODULE_NAME}/templates/seller-customer-transactions.html`)
            .then(
                response => {
        ...
        $http.get(`./build/${MODULE_NAME}/templates/seller-customer-transfers.html`)
            .then(
                response => {
        ...
        $http.get(`./build/${MODULE_NAME}/templates/seller-customer-campaigns.html`)
            .then(
                response => {
