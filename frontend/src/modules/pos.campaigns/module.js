...
angular.module(MODULE_NAME, [])
        ...
        $stateProvider
            .state('seller.panel.campaigns', {
                ...
                views: {
                    ...
                    'main@': {
                        templateUrl: './templates/seller-campaign-list.html',
                        controller: 'CampaignController',
                        controllerAs: 'CampaignCtrl'
                    },
                    'extendBottom@': {
            ...
            .state('seller.single-campaign', {
                ...
                views: {
                    ...
                    'main@': {
                        templateUrl: './templates/seller-single-campaign.html',
                        controller: 'CampaignController',
                        controllerAs: 'CampaignCtrl'
                    },
                    'extendBottom@': {
    ...
    .run(($templateCache, $http) => {
        ...
        $http.get(`./build/${MODULE_NAME}/templates/seller-campaign-list.html`)
            .then(
                response => {
        ...
        $http.get(`./build/${MODULE_NAME}/templates/seller-single-campaign.html`)
            .then(
                response => {
